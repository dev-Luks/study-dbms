...
CREATE TABLE TBL_PET1(
   PET_NUMBER NUMBER CONSTRAINT PK_PET1 PRIMARY KEY,
   PET_TYPE VARCHAR2(1000) CONSTRAINT REQUIER_PET_TYPE NOT NULL,
   PET_NAME VARCHAR2(1000) CONSTRAINT REQUIER_PET_NAME1 NOT NULL,
...
--SELECT *FROM TBL_PET1;
--
--/*반려 동물 추가: 동일한 보호자로 지정*/
--INSERT INTO TBL_PET1
--(PET_NUMBER, PET_TYPE, PET_NAME, PET_AGE, PET_ILL_NAME, OWNER_NUMBER)
--VALUES(SEQ_OWNER.NEXTVAL, '고양이', '크림', 3, '내성발톱', 1);
--
--INSERT INTO TBL_PET1
--(PET_NUMBER, PET_TYPE, PET_NAME, PET_AGE, PET_ILL_NAME, OWNER_NUMBER)
--VALUES(SEQ_OWNER.NEXTVAL, '고양이', '슈', 3, '귀여움', 1);
--
--/*두 마리 이상의 반려동물 보호자의 핸드폰 번호를 다른 번호로 변경*/
--
--UPDATE TBL_OWNER
--SET OWNER_PHONE='01043214321'
--WHERE OWNER_NUMBER ='1';
--
--/*반려 동물을 키우고 있는 보호자를 병원 보호자 명단에서 삭제*/
--DELETE FROM TBL_OWNER
--WHERE OWNER_NUMBER=3;

/*      
 *  조합기 사용한 테이블들
CREATE TABLE TBL_GUARDIAN(
	GUARDIAN_NAME VARCHAR2(1000),
	GUARDIAN_PHONENUMBER VARCHAR2(1000),
	GUARDIAN_AGE NUMBER CONSTRAINT REQUIER_AGE1 NOT NULL,
	GUARDIAN_ADRESS VARCHAR(1000) CONSTRAINT REQUIER_ADRESS NOT NULL,
	CONSTRAINT PK_GUARDIAN PRIMARY KEY(GUARDIAN_NAME, GUARDIAN_PHONENUMBER)
); 

CREATE TABLE TBL_PET(
	PET_ID NUMBER CONSTRAINT PK_PET PRIMARY KEY,
	PET_NAME VARCHAR2(1000) CONSTRAINT REQUIER_NAME1 NOT NULL,
	PET_AGE NUMBER CONSTRAINT REQUIER_NUMBER NOT NULL,
	PET_DISEASE VARCHAR2(1000) CONSTRAINT REQUIER_DIESASE NOT NULL,
	GUARDIAN_NAME VARCHAR2(1000),
	GUARDIAN_PHONENUMBER VARCHAR2(1000),
	CONSTRAINT FK_PET_GUARIDAN FOREIGN KEY(GUARDIAN_NAME, GUARDIAN_PHONENUMBER)
	REFERENCES TBL_GUARDIAN(GUARDIAN_NAME, GUARDIAN_PHONENUMBER)
);
*/
